"""
Django settings for lunasci project.
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'Assignment for Luna Scientific to create a hydroponics management app with Django REST Framework',
    'VERSION': '1.0.0',
